...
// const fruits = ['apple' , 'banana' , 'orange' , 'melon', 'gwava']
// console.log(fruits.slice(1 , 4))
// console.log(fruits.indexOf('apple'))
// console.log(fruits.includes('gwava' ))
...
// console.log(username[username.length - 3]);

//  const username = 'MuhammadAbdullah';
